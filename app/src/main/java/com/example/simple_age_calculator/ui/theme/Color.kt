package com.example.simple_age_calculator.ui.theme
...
val TextFieldColor = Color(0xFFEEE6D9)
val MainButton = Color(0xFFEB6123)
val ResetButton = Color(0xFFFFD1B3)
val BottomSheetColor = Color(0xFFFDEDE1)